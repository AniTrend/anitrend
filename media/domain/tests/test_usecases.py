...
class TestMediaUseCase(unittest.TestCase):
    ...
    def test_fetch_series_success(self):
        ...
        result = self.use_case.fetch_series(
            headers=self.test_headers, anilist=self.test_series_id
        )
